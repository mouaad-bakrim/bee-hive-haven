      ...
      <div className="min-h-screen flex bg-background">
              ...
              const link = (
                <Link
                  ...
                  className={`flex items-center gap-3 rounded-lg text-sm font-medium transition-all duration-200 ${
                    ...
                    isActive(item.path)
                      ? "bg-primary/15 text-primary honey-shadow"
            ...
            {collapsed ? (
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    onClick={signOut}
                    className="flex items-center justify-center w-full px-2 py-2.5 rounded-lg text-sm font-medium text-muted-foreground hover:text-destructive hover:bg-destructive/5 transition-colors"
                  >
        ...
        <div className="flex-1 flex flex-col min-h-screen">
          ...
          <header className="h-14 border-b border-border bg-card flex items-center px-4 gap-3 sticky top-0 z-30">
            {/* Mobile hamburger */}
            <button onClick={() => setMobileOpen(true)} className="lg:hidden p-1.5 rounded-lg hover:bg-secondary/50">
